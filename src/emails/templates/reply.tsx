...
function ReplyEmailTemplate(props: ReplyEmailTemplateProps) {
  ...
  return (
    <Html>
      ...
      <Preview>New reply on the post "{postTitle}" on braviaprime.com</Preview>
      <Tailwind>
        <Body className='m-auto bg-white p-1'>
          <Container className='mx-auto w-full max-w-165 rounded-2xl border border-solid border-[#e5e5e5] bg-white p-8'>
            ...
            <Text className='text-xs text-gray-500'>
              ...
              <Link href='https://braviaprime.com/account/settings'>account settings</Link>. To stop receiving reply
...
ReplyEmailTemplate.PreviewProps = {
  ...
  replierImage: 'https://braviaprime.com/api/avatar/john-doe',
